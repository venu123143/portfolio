...
export default function About() {
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 overflow-x-hidden">
              ...
              <Card className="p-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-xl">
                <CardContent className="space-y-6">
                  <div className="flex items-center space-x-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold font-poppins text-slate-900 dark:text-white">Professional Journey</h3>
                  </div>
              ...
              >
                <Card className="p-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
                  <CardContent className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white font-poppins mb-1">{achievement.title}</h3>
