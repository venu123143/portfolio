    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Associate Software Engineer with 2+ years of experience in full-stack development. Specialized in React.js, Node.js, TypeScript, and cloud technologies. Best Beginner Award and Star Performer Award winner at Ahex Technologies."
                />
                <meta
                    name="keywords"
                    content="Venu Gopal Reddy, Associate Software Engineer, Full Stack Developer, Mern Stack Developer, React.js Developer, Node.js Developer, TypeScript Developer, Ahex Technologies, Best Beginner Award, CI/CD, DevOps, GraphQL, MongoDB, MySQL, PostgreSQL, AWS, Azure, Linux, Nginx, Socket.io, WebRTC, Mediasoup, WebSockets, REST APIs, Agile, Scrum, Software Development"
                />
